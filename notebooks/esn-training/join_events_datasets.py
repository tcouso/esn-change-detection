...
def join_events_datasets() -> None:
    ...
    stable_signal_path = paths.data_interim_dir("stable", "stable_" + selected_band + ".csv")
    drought_signal_path = paths.data_interim_dir("drought", "drought_" + selected_band + ".csv")
    logging_signal_path = paths.data_interim_dir("logging", "logging_" + selected_band + ".csv")
    fire_signal_path = paths.data_interim_dir("fire", "fire_" + selected_band + ".csv")
    ...
    dataset_path = paths.data_interim_dir("dataset") / dataset_filename

    create_output_path(dataset_path)
