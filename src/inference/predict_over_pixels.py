...
from src.inference.change_detection import detect_changes_in_pixel
from src.data.utils import create_output_path

# TODO: adapt this to boolean vector predictions
...
def predict_over_pixels(
    ...
    for N, k in product(N_values, k_values):
        ...
        for simulation in signal_simulations:
            ...
            pred, date = detect_changes_in_pixel(**fault_detection_params)
